...
<html lang="pt">
	<head>
       <meta charset="UTF-8">
	    ...
	    <link rel="icon" type="image/ico" href="public/assets/img/icon-logo.ico">
	...
	<body>
							...
							<div class="container-fluid">
								...
								<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
									<ul class="nav navbar-nav menu-header">
										<li>
											<a href="/" class="active" title="Rasador - Empresa">Home</a>
										</li>
										<li>
		...
		<footer>
			<div class="container">
				...
				<!-- div class="col-md-12 col-xs-12 autor">
					<a href="http://www.agenciafatto.com.br" title="" target="_blank">
						<img src="public/assets/img/logo-fatto.png" alt="">
					</a>
				</div> -->
			</div>
		</footer>
